...
import com.memesgmm.linear.benchmark.PregenExporter;
import com.memesgmm.linear.command.LinearCommand;
import com.memesgmm.linear.config.ForgeLinearConfig;
...
public class Linear {
    ...
    public Linear(IEventBus modEventBus, ModContainer modContainer) {
        modContainer.registerConfig(ModConfig.Type.COMMON, ForgeLinearConfig.SPEC, "linear-server.toml");
    ...
    private void onConfigReload(ModConfigEvent.Reloading event) {
        if (event.getConfig().getSpec() == ForgeLinearConfig.SPEC) {
            ForgeLinearConfig.pushToLinearConfig();
            LinearRuntime.LOGGER.info("[Linear] Config reloaded.");
        }
    }
    ...
    public void onLevelSave(LevelEvent.Save event) {
        LinearRuntime.LOGGER.debug("[Linear] onLevelSave called");
        runtime.onLevelSave();
    }
